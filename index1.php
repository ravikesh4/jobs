...
?>
    <div class="header">
        <form method="POST" action="search.php">
            ...
            <div class="form-box">
                <input type="text" class="search-field skills" name="key" placeholder="Skills, Keywords..." required />
                <input type="text" class="search-field location" name="location" placeholder="Location" required/>
